export const accountData = {
  'Personal INR': {
    ...
    transactions: [
      ...
      { id: 9, date: '2026-04-07', description: 'Gym membership', category: 'Health', amount: -42, type: 'expense', status: 'Completed' },
      { id: 10, date: '2026-04-07', description: 'Client bonus', category: 'Income', amount: 520, type: 'income', status: 'Completed' },
      { id: 11, date: '2026-04-08', description: 'Pharmacy', category: 'Health', amount: -26.4, type: 'expense', status: 'Completed' },
      { id: 12, date: '2026-04-08', description: 'Electricity bill', category: 'Bills', amount: -86.75, type: 'expense', status: 'Pending' },
      { id: 13, date: '2026-04-09', description: 'Lunch with team', category: 'Food', amount: -31.2, type: 'expense', status: 'Completed' },
      { id: 14, date: '2026-04-09', description: 'Refund: flight', category: 'Travel', amount: 180, type: 'income', status: 'Completed' },
      ...
      { id: 18, date: '2026-04-11', description: 'Project milestone', category: 'Income', amount: 980, type: 'income', status: 'Completed' },
      { id: 19, date: '2026-04-12', description: 'Mobile plan', category: 'Bills', amount: -19.99, type: 'expense', status: 'Completed' },
      { id: 20, date: '2026-04-12', description: 'Weekend groceries', category: 'Food', amount: -74.3, type: 'expense', status: 'Completed' },
    ],
  },
  'Savings EUR': {
    label: 'Savings EUR',
