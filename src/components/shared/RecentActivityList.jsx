  ...
  return (
    <div className="grid gap-3">
      {recentActivity.map((activity) => (
        <div className="flex items-center justify-between gap-3 rounded-[0.85rem] border border-[#e6ebf7] bg-gradient-to-b from-white to-[#f9fbff] px-3 py-3" key={activity.id}>
          <div>
