export function BalanceCard({ account, formatCurrency }) {
  return (
    <article className="relative flex min-h-[188px] flex-col justify-center overflow-hidden rounded-2xl border-0 bg-[linear-gradient(142deg,#ff7e4f,#ff9f5f_57%,#ffb675_100%)] p-4 text-[#fffdf9] shadow-[0_14px_26px_rgba(255,127,79,0.28)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_20px_38px_rgba(255,127,79,0.32)]">
