...
export function DashboardHeaderBar({ role, setRole, theme, setTheme, onOpenSidebar }) {
  return (
    <header className="grid items-center gap-4 border-b border-[color:var(--app-border)] px-1 pt-1 pb-3 md:grid-cols-[auto_minmax(0,1fr)] max-[720px]:gap-3 max-[720px]:justify-items-start">
      ...
      <div className="grid w-auto max-w-none items-center gap-2 justify-self-end sm:grid-cols-[auto_auto_auto] md:grid-cols-[auto_auto_auto_auto] md:justify-self-stretch lg:justify-self-end max-[720px]:w-full max-[720px]:grid-cols-[auto_auto_auto] max-[720px]:justify-between max-[720px]:justify-self-start">
        ...
        <label className="grid gap-1 text-[0.68rem] text-[color:var(--app-muted)] sm:justify-self-start" htmlFor="theme-switch">
          Theme
          <PanelSelect
            id="theme-switch"
        ...
        <label className="grid gap-1 text-[0.68rem] text-[color:var(--app-muted)] sm:justify-self-start lg:justify-self-end" htmlFor="role-switch">
          Role
          <PanelSelect
            id="role-switch"
            className="rounded-xl px-2 text-[color:var(--app-text)]"
        ...
        <div className="inline-flex items-center gap-2 justify-self-end text-[0.86rem] font-bold text-[color:var(--app-text)] sm:justify-self-start">
          <div
