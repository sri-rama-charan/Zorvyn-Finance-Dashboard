export function TransactionRow({ transaction, formatCurrency, currency }) {
  ...
  return (
    <div
      className="relative grid grid-cols-[1.1fr_1.5fr_0.9fr_0.75fr_0.9fr] items-center gap-2 border-t border-[#edf1fb] px-4 py-3 text-[0.84rem] text-[#283a75] odd:bg-white even:bg-[#fbfcff] transition-all duration-200 hover:-translate-y-[1px] hover:bg-white hover:shadow-[0_8px_16px_rgba(25,37,86,0.08)] max-[720px]:grid-cols-[1fr_1.2fr_1fr]"
      key={transaction.id}
    >
