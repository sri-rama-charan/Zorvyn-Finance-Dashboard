...
export function InsightsHeaderBar({ theme, setTheme, onBackToDashboardRoute }) {
  return (
    <header className="grid items-center gap-4 border-b border-[color:var(--app-border)] px-1 pt-1 pb-3 md:grid-cols-[auto_minmax(0,1fr)] max-[720px]:grid-cols-1 max-[720px]:items-start">
      <div>
      ...
      <div className="grid w-auto max-w-none items-center gap-2 justify-self-end sm:grid-cols-[auto_auto] max-[720px]:w-full max-[720px]:grid-cols-1 max-[720px]:justify-self-start">
